 ...
 * - Rewrite register definitions with DMA9_BASE.
 */

#define DMA9_BASE                                                0x007900
#define DMA9_CS                                                  HW_REGISTER_RW( DMA9_BASE+0x00 ) 
   #define DMA9_CS_MASK                                          0xf0ff017f
   #define DMA9_CS_WIDTH                                         32
   #define DMA9_CS_RESET                                         0x00000000
...
#define DMA9_CONBLK_AD                                           HW_REGISTER_RW( DMA9_BASE+0x04 ) 
   #define DMA9_CONBLK_AD_MASK                                   0xffffffe0
   #define DMA9_CONBLK_AD_WIDTH                                  32
   #define DMA9_CONBLK_AD_RESET                                  0x00000000
...
#define DMA9_TI                                                  HW_REGISTER_RO( DMA9_BASE+0x08 ) 
...
#define DMA9_SOURCE_AD                                           HW_REGISTER_RO( DMA9_BASE+0x0c ) 
...
#define DMA9_DEST_AD                                             HW_REGISTER_RO( DMA9_BASE+0x10 ) 
...
#define DMA9_TXFR_LEN                                            HW_REGISTER_RO( DMA9_BASE+0x14 ) 
...
#define DMA9_NEXTCONBK                                           HW_REGISTER_RO( DMA9_BASE+0x1c ) 
...
#define DMA9_DEBUG                                               HW_REGISTER_RW( DMA9_BASE+0x20 ) 
   #define DMA9_DEBUG_MASK                                       0x1ffffff7
   #define DMA9_DEBUG_WIDTH                                      29
   #define DMA9_DEBUG_RESET                                      0x00000000
