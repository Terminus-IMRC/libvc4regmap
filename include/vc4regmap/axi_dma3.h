 ...
 * - Rewrite register definitions with DMA3_BASE.
 */

#define DMA3_BASE                                                0x007300
#define DMA3_CS                                                  HW_REGISTER_RW( DMA3_BASE+0x00 ) 
   #define DMA3_CS_MASK                                          0xf0ff017f
   #define DMA3_CS_WIDTH                                         32
   #define DMA3_CS_RESET                                         0x00000000
...
#define DMA3_CONBLK_AD                                           HW_REGISTER_RW( DMA3_BASE+0x04 ) 
   #define DMA3_CONBLK_AD_MASK                                   0xffffffe0
   #define DMA3_CONBLK_AD_WIDTH                                  32
   #define DMA3_CONBLK_AD_RESET                                  0x00000000
...
#define DMA3_TI                                                  HW_REGISTER_RO( DMA3_BASE+0x08 ) 
...
#define DMA3_SOURCE_AD                                           HW_REGISTER_RO( DMA3_BASE+0x0c ) 
...
#define DMA3_DEST_AD                                             HW_REGISTER_RO( DMA3_BASE+0x10 ) 
...
#define DMA3_TXFR_LEN                                            HW_REGISTER_RO( DMA3_BASE+0x14 ) 
...
#define DMA3_STRIDE                                              HW_REGISTER_RO( DMA3_BASE+0x18 ) 
...
#define DMA3_NEXTCONBK                                           HW_REGISTER_RO( DMA3_BASE+0x1c ) 
...
#define DMA3_DEBUG                                               HW_REGISTER_RW( DMA3_BASE+0x20 ) 
   #define DMA3_DEBUG_MASK                                       0x1ffffff7
   #define DMA3_DEBUG_WIDTH                                      29
   #define DMA3_DEBUG_RESET                                      0x00000000
