 ...
 * - Rewrite register definitions with DMA0_BASE.
 */

#define DMA0_BASE                                                0x007000
#define DMA0_CS                                                  HW_REGISTER_RW( DMA0_BASE+0x00 ) 
   #define DMA0_CS_MASK                                          0xf0ff017f
   #define DMA0_CS_WIDTH                                         32
   #define DMA0_CS_RESET                                         0x00000000
...
#define DMA0_CONBLK_AD                                           HW_REGISTER_RW( DMA0_BASE+0x04 ) 
   #define DMA0_CONBLK_AD_MASK                                   0xffffffe0
   #define DMA0_CONBLK_AD_WIDTH                                  32
   #define DMA0_CONBLK_AD_RESET                                  0x00000000
...
#define DMA0_TI                                                  HW_REGISTER_RO( DMA0_BASE+0x08 ) 
...
#define DMA0_SOURCE_AD                                           HW_REGISTER_RO( DMA0_BASE+0x0c ) 
...
#define DMA0_DEST_AD                                             HW_REGISTER_RO( DMA0_BASE+0x10 ) 
...
#define DMA0_TXFR_LEN                                            HW_REGISTER_RO( DMA0_BASE+0x14 ) 
...
#define DMA0_STRIDE                                              HW_REGISTER_RO( DMA0_BASE+0x18 ) 
...
#define DMA0_NEXTCONBK                                           HW_REGISTER_RO( DMA0_BASE+0x1c ) 
...
#define DMA0_DEBUG                                               HW_REGISTER_RW( DMA0_BASE+0x20 ) 
   #define DMA0_DEBUG_MASK                                       0x1ffffff7
   #define DMA0_DEBUG_WIDTH                                      29
   #define DMA0_DEBUG_RESET                                      0x00000000
