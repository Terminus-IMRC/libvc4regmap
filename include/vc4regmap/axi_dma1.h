 ...
 * - Rewrite register definitions with DMA1_BASE.
 */

#define DMA1_BASE                                                0x007100
#define DMA1_CS                                                  HW_REGISTER_RW( DMA1_BASE+0x00 ) 
   #define DMA1_CS_MASK                                          0xf0ff017f
   #define DMA1_CS_WIDTH                                         32
   #define DMA1_CS_RESET                                         0x00000000
...
#define DMA1_CONBLK_AD                                           HW_REGISTER_RW( DMA1_BASE+0x04 ) 
   #define DMA1_CONBLK_AD_MASK                                   0xffffffe0
   #define DMA1_CONBLK_AD_WIDTH                                  32
   #define DMA1_CONBLK_AD_RESET                                  0x00000000
...
#define DMA1_TI                                                  HW_REGISTER_RO( DMA1_BASE+0x08 ) 
...
#define DMA1_SOURCE_AD                                           HW_REGISTER_RO( DMA1_BASE+0x0c ) 
...
#define DMA1_DEST_AD                                             HW_REGISTER_RO( DMA1_BASE+0x10 ) 
...
#define DMA1_TXFR_LEN                                            HW_REGISTER_RO( DMA1_BASE+0x14 ) 
...
#define DMA1_STRIDE                                              HW_REGISTER_RO( DMA1_BASE+0x18 ) 
...
#define DMA1_NEXTCONBK                                           HW_REGISTER_RO( DMA1_BASE+0x1c ) 
...
#define DMA1_DEBUG                                               HW_REGISTER_RW( DMA1_BASE+0x20 ) 
   #define DMA1_DEBUG_MASK                                       0x1ffffff7
   #define DMA1_DEBUG_WIDTH                                      29
   #define DMA1_DEBUG_RESET                                      0x00000000
