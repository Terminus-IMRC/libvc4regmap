...
#define PM_GNRIC                                                 HW_REGISTER_RW( PM_BASE + 0x00 )
   ...
   #define PM_GNRIC_RESET                                        0x00000000
...
#define PM_AUDIO                                                 HW_REGISTER_RW( PM_BASE + 0x04 )
...
#define PM_IMAGE                                                 HW_REGISTER_RW( PM_BASE + 0x08 )
...
#define PM_GRAFX                                                 HW_REGISTER_RW( PM_BASE + 0x0c )
...
#define PM_PROC                                                  HW_REGISTER_RW( PM_BASE + 0x10 )
   #define PM_PROC_MASK                                          0x007f107f
   #define PM_PROC_WIDTH                                         23
   #define PM_PROC_RESET                                         0x00000000
...
#define PM_STATUS                                                HW_REGISTER_RW( PM_BASE + 0x18 )
   #define PM_STATUS_MASK                                        0x00ffffff
   #define PM_STATUS_WIDTH                                       24
   #define PM_STATUS_RESET                                       0x00000000
#define PM_RSTC                                                  HW_REGISTER_RW( PM_BASE + 0x1c )
...
#define PM_RSTS                                                  HW_REGISTER_RW( PM_BASE + 0x20 )
...
#define PM_WDOG                                                  HW_REGISTER_RW( PM_BASE + 0x24 )
...
#define PM_PADS0                                                 HW_REGISTER_RW( PM_BASE + 0x28 )
...
#define PM_PADS2                                                 HW_REGISTER_RW( PM_BASE + 0x2c )
...
#define PM_PADS3                                                 HW_REGISTER_RW( PM_BASE + 0x30 )
...
#define PM_PADS4                                                 HW_REGISTER_RW( PM_BASE + 0x34 )
...
#define PM_PADS5                                                 HW_REGISTER_RW( PM_BASE + 0x38 )
...
#define PM_PADS6                                                 HW_REGISTER_RW( PM_BASE + 0x3c )
   #define PM_PADS6_MASK                                         0x00000123
   #define PM_PADS6_WIDTH                                        9
   #define PM_PADS6_RESET                                        0x00000000
...
#define PM_CAM0                                                  HW_REGISTER_RW( PM_BASE + 0x44 )
   #define PM_CAM0_MASK                                          0x001fffff
   #define PM_CAM0_WIDTH                                         21
   #define PM_CAM0_RESET                                         0x00000000
...
#define PM_CAM1                                                  HW_REGISTER_RW( PM_BASE + 0x48 )
   #define PM_CAM1_MASK                                          0x001fffff
   #define PM_CAM1_WIDTH                                         21
   #define PM_CAM1_RESET                                         0x00000000
...
#define PM_CCP2TX                                                HW_REGISTER_RW( PM_BASE + 0x4c )
   #define PM_CCP2TX_MASK                                        0x0007ffff
   #define PM_CCP2TX_WIDTH                                       19
   #define PM_CCP2TX_RESET                                       0x00000000
...
#define PM_DSI0                                                  HW_REGISTER_RW( PM_BASE + 0x50 )
   #define PM_DSI0_MASK                                          0x001fffff
   #define PM_DSI0_WIDTH                                         21
   #define PM_DSI0_RESET                                         0x00000000
...
#define PM_DSI1                                                  HW_REGISTER_RW( PM_BASE + 0x54 )
   #define PM_DSI1_MASK                                          0x001fffff
   #define PM_DSI1_WIDTH                                         21
   #define PM_DSI1_RESET                                         0x00000000
...
#define PM_HDMI                                                  HW_REGISTER_RW( PM_BASE + 0x58 )
...
#define PM_USB                                                   HW_REGISTER_RW( PM_BASE + 0x5c )
   #define PM_USB_MASK                                           0x00000001
   #define PM_USB_WIDTH                                          1
   #define PM_USB_RESET                                          0x00000000
...
#define PM_PXLDO                                                 HW_REGISTER_RW( PM_BASE + 0x60 )
   #define PM_PXLDO_MASK                                         0x0003ffff
   #define PM_PXLDO_WIDTH                                        18
   #define PM_PXLDO_RESET                                        0x00000000
...
#define PM_PXBG                                                  HW_REGISTER_RW( PM_BASE + 0x64 )
   #define PM_PXBG_MASK                                          0x0000ffff
   #define PM_PXBG_WIDTH                                         16
   #define PM_PXBG_RESET                                         0x00000000
...
#define PM_DFT                                                   HW_REGISTER_RW( PM_BASE + 0x68 )
   #define PM_DFT_MASK                                           0x00000003
   #define PM_DFT_WIDTH                                          2
   #define PM_DFT_RESET                                          0x00000000
...
#define PM_SMPS                                                  HW_REGISTER_RW( PM_BASE + 0x6c )
   #define PM_SMPS_MASK                                          0x00000007
   #define PM_SMPS_WIDTH                                         3
   #define PM_SMPS_RESET                                         0x00000000
...
#define PM_XOSC                                                  HW_REGISTER_RW( PM_BASE + 0x70 )
   #define PM_XOSC_MASK                                          0x00000001
   #define PM_XOSC_WIDTH                                         1
   #define PM_XOSC_RESET                                         0x00000000
...
#define PM_SPAREW                                                HW_REGISTER_RW( PM_BASE + 0x74 )
   #define PM_SPAREW_MASK                                        0x00ffffff
   #define PM_SPAREW_WIDTH                                       24
   #define PM_SPAREW_RESET                                       0x00000000
...
#define PM_SPARER                                                HW_REGISTER_RW( PM_BASE + 0x78 )
   #define PM_SPARER_MASK                                        0x00ffffff
   #define PM_SPARER_WIDTH                                       24
   #define PM_SPARER_RESET                                       0x00000000
...
#define PM_AVS_RSTDR                                             HW_REGISTER_RW( PM_BASE + 0x7c )
   #define PM_AVS_RSTDR_MASK                                     0x0000003f
   #define PM_AVS_RSTDR_WIDTH                                    6
   #define PM_AVS_RSTDR_RESET                                    0x00000000
...
#define PM_AVS_STAT                                              HW_REGISTER_RW( PM_BASE + 0x80 )
   #define PM_AVS_STAT_MASK                                      0x0000001f
   #define PM_AVS_STAT_WIDTH                                     5
   #define PM_AVS_STAT_RESET                                     0x00000000
...
#define PM_AVS_EVENT                                             HW_REGISTER_RW( PM_BASE + 0x84 )
   #define PM_AVS_EVENT_MASK                                     0x0000001f
   #define PM_AVS_EVENT_WIDTH                                    5
   #define PM_AVS_EVENT_RESET                                    0x00000000
...
#define PM_AVS_INTEN                                             HW_REGISTER_RW( PM_BASE + 0x88 )
   #define PM_AVS_INTEN_MASK                                     0x0000001f
   #define PM_AVS_INTEN_WIDTH                                    5
   #define PM_AVS_INTEN_RESET                                    0x00000000
...
#define PM_DUMMY                                                 HW_REGISTER_RW( PM_BASE + 0xfc )
