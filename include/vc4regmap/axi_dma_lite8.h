 ...
 * - Rewrite register definitions with DMA8_BASE.
 */

#define DMA8_BASE                                                0x007800
#define DMA8_CS                                                  HW_REGISTER_RW( DMA8_BASE+0x00 ) 
   #define DMA8_CS_MASK                                          0xf0ff017f
   #define DMA8_CS_WIDTH                                         32
   #define DMA8_CS_RESET                                         0x00000000
...
#define DMA8_CONBLK_AD                                           HW_REGISTER_RW( DMA8_BASE+0x04 ) 
   #define DMA8_CONBLK_AD_MASK                                   0xffffffe0
   #define DMA8_CONBLK_AD_WIDTH                                  32
   #define DMA8_CONBLK_AD_RESET                                  0x00000000
...
#define DMA8_TI                                                  HW_REGISTER_RO( DMA8_BASE+0x08 ) 
...
#define DMA8_SOURCE_AD                                           HW_REGISTER_RO( DMA8_BASE+0x0c ) 
...
#define DMA8_DEST_AD                                             HW_REGISTER_RO( DMA8_BASE+0x10 ) 
...
#define DMA8_TXFR_LEN                                            HW_REGISTER_RO( DMA8_BASE+0x14 ) 
...
#define DMA8_NEXTCONBK                                           HW_REGISTER_RO( DMA8_BASE+0x1c ) 
...
#define DMA8_DEBUG                                               HW_REGISTER_RW( DMA8_BASE+0x20 ) 
   #define DMA8_DEBUG_MASK                                       0x1ffffff7
   #define DMA8_DEBUG_WIDTH                                      29
   #define DMA8_DEBUG_RESET                                      0x00000000
