 ...
 * - Rewrite register definitions with DMA5_BASE.
 */

#define DMA5_BASE                                                0x007500
#define DMA5_CS                                                  HW_REGISTER_RW( DMA5_BASE+0x00 ) 
   #define DMA5_CS_MASK                                          0xf0ff017f
   #define DMA5_CS_WIDTH                                         32
   #define DMA5_CS_RESET                                         0x00000000
...
#define DMA5_CONBLK_AD                                           HW_REGISTER_RW( DMA5_BASE+0x04 ) 
   #define DMA5_CONBLK_AD_MASK                                   0xffffffe0
   #define DMA5_CONBLK_AD_WIDTH                                  32
   #define DMA5_CONBLK_AD_RESET                                  0x00000000
...
#define DMA5_TI                                                  HW_REGISTER_RO( DMA5_BASE+0x08 ) 
...
#define DMA5_SOURCE_AD                                           HW_REGISTER_RO( DMA5_BASE+0x0c ) 
...
#define DMA5_DEST_AD                                             HW_REGISTER_RO( DMA5_BASE+0x10 ) 
...
#define DMA5_TXFR_LEN                                            HW_REGISTER_RO( DMA5_BASE+0x14 ) 
...
#define DMA5_STRIDE                                              HW_REGISTER_RO( DMA5_BASE+0x18 ) 
...
#define DMA5_NEXTCONBK                                           HW_REGISTER_RO( DMA5_BASE+0x1c ) 
...
#define DMA5_DEBUG                                               HW_REGISTER_RW( DMA5_BASE+0x20 ) 
   #define DMA5_DEBUG_MASK                                       0x1ffffff7
   #define DMA5_DEBUG_WIDTH                                      29
   #define DMA5_DEBUG_RESET                                      0x00000000
