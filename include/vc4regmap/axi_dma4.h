 ...
 * - Rewrite register definitions with DMA4_BASE.
 */

#define DMA4_BASE                                                0x007400
#define DMA4_CS                                                  HW_REGISTER_RW( DMA4_BASE+0x00 ) 
   #define DMA4_CS_MASK                                          0xf0ff017f
   #define DMA4_CS_WIDTH                                         32
   #define DMA4_CS_RESET                                         0x00000000
...
#define DMA4_CONBLK_AD                                           HW_REGISTER_RW( DMA4_BASE+0x04 ) 
   #define DMA4_CONBLK_AD_MASK                                   0xffffffe0
   #define DMA4_CONBLK_AD_WIDTH                                  32
   #define DMA4_CONBLK_AD_RESET                                  0x00000000
...
#define DMA4_TI                                                  HW_REGISTER_RO( DMA4_BASE+0x08 ) 
...
#define DMA4_SOURCE_AD                                           HW_REGISTER_RO( DMA4_BASE+0x0c ) 
...
#define DMA4_DEST_AD                                             HW_REGISTER_RO( DMA4_BASE+0x10 ) 
...
#define DMA4_TXFR_LEN                                            HW_REGISTER_RO( DMA4_BASE+0x14 ) 
...
#define DMA4_STRIDE                                              HW_REGISTER_RO( DMA4_BASE+0x18 ) 
...
#define DMA4_NEXTCONBK                                           HW_REGISTER_RO( DMA4_BASE+0x1c ) 
...
#define DMA4_DEBUG                                               HW_REGISTER_RW( DMA4_BASE+0x20 ) 
   #define DMA4_DEBUG_MASK                                       0x1ffffff7
   #define DMA4_DEBUG_WIDTH                                      29
   #define DMA4_DEBUG_RESET                                      0x00000000
