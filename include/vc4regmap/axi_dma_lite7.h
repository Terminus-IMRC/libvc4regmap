 ...
 * - Rewrite register definitions with DMA7_BASE.
 */

#define DMA7_BASE                                                0x007700
#define DMA7_CS                                                  HW_REGISTER_RW( DMA7_BASE+0x00 ) 
   #define DMA7_CS_MASK                                          0xf0ff017f
   #define DMA7_CS_WIDTH                                         32
   #define DMA7_CS_RESET                                         0x00000000
...
#define DMA7_CONBLK_AD                                           HW_REGISTER_RW( DMA7_BASE+0x04 ) 
   #define DMA7_CONBLK_AD_MASK                                   0xffffffe0
   #define DMA7_CONBLK_AD_WIDTH                                  32
   #define DMA7_CONBLK_AD_RESET                                  0x00000000
...
#define DMA7_TI                                                  HW_REGISTER_RO( DMA7_BASE+0x08 ) 
...
#define DMA7_SOURCE_AD                                           HW_REGISTER_RO( DMA7_BASE+0x0c ) 
...
#define DMA7_DEST_AD                                             HW_REGISTER_RO( DMA7_BASE+0x10 ) 
...
#define DMA7_TXFR_LEN                                            HW_REGISTER_RO( DMA7_BASE+0x14 ) 
...
#define DMA7_NEXTCONBK                                           HW_REGISTER_RO( DMA7_BASE+0x1c ) 
...
#define DMA7_DEBUG                                               HW_REGISTER_RW( DMA7_BASE+0x20 ) 
   #define DMA7_DEBUG_MASK                                       0x1ffffff7
   #define DMA7_DEBUG_WIDTH                                      29
   #define DMA7_DEBUG_RESET                                      0x00000000
