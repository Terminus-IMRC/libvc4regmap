 ...
 * - Rewrite register definitions with DMA11_BASE.
 */

#define DMA11_BASE                                               0x007b00
#define DMA11_CS                                                 HW_REGISTER_RW( DMA11_BASE+0x00 ) 
   #define DMA11_CS_MASK                                         0xf0ff017f
   #define DMA11_CS_WIDTH                                        32
   #define DMA11_CS_RESET                                        0x00000000
...
#define DMA11_CONBLK_AD                                          HW_REGISTER_RW( DMA11_BASE+0x04 ) 
   #define DMA11_CONBLK_AD_MASK                                  0xffffffe0
   #define DMA11_CONBLK_AD_WIDTH                                 32
   #define DMA11_CONBLK_AD_RESET                                 0x00000000
...
#define DMA11_TI                                                 HW_REGISTER_RO( DMA11_BASE+0x08 ) 
...
#define DMA11_SOURCE_AD                                          HW_REGISTER_RO( DMA11_BASE+0x0c ) 
...
#define DMA11_DEST_AD                                            HW_REGISTER_RO( DMA11_BASE+0x10 ) 
...
#define DMA11_TXFR_LEN                                           HW_REGISTER_RO( DMA11_BASE+0x14 ) 
...
#define DMA11_NEXTCONBK                                          HW_REGISTER_RO( DMA11_BASE+0x1c ) 
...
#define DMA11_DEBUG                                              HW_REGISTER_RW( DMA11_BASE+0x20 ) 
   #define DMA11_DEBUG_MASK                                      0x1ffffff7
   #define DMA11_DEBUG_WIDTH                                     29
   #define DMA11_DEBUG_RESET                                     0x00000000
