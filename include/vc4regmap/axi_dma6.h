 ...
 * - Rewrite register definitions with DMA6_BASE.
 */

#define DMA6_BASE                                                0x007600
#define DMA6_CS                                                  HW_REGISTER_RW( DMA6_BASE+0x00 ) 
   #define DMA6_CS_MASK                                          0xf0ff017f
   #define DMA6_CS_WIDTH                                         32
   #define DMA6_CS_RESET                                         0x00000000
...
#define DMA6_CONBLK_AD                                           HW_REGISTER_RW( DMA6_BASE+0x04 ) 
   #define DMA6_CONBLK_AD_MASK                                   0xffffffe0
   #define DMA6_CONBLK_AD_WIDTH                                  32
   #define DMA6_CONBLK_AD_RESET                                  0x00000000
...
#define DMA6_TI                                                  HW_REGISTER_RO( DMA6_BASE+0x08 ) 
...
#define DMA6_SOURCE_AD                                           HW_REGISTER_RO( DMA6_BASE+0x0c ) 
...
#define DMA6_DEST_AD                                             HW_REGISTER_RO( DMA6_BASE+0x10 ) 
...
#define DMA6_TXFR_LEN                                            HW_REGISTER_RO( DMA6_BASE+0x14 ) 
...
#define DMA6_STRIDE                                              HW_REGISTER_RO( DMA6_BASE+0x18 ) 
...
#define DMA6_NEXTCONBK                                           HW_REGISTER_RO( DMA6_BASE+0x1c ) 
...
#define DMA6_DEBUG                                               HW_REGISTER_RW( DMA6_BASE+0x20 ) 
   #define DMA6_DEBUG_MASK                                       0x1ffffff7
   #define DMA6_DEBUG_WIDTH                                      29
   #define DMA6_DEBUG_RESET                                      0x00000000
