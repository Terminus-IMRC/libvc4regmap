 ...
 * - Rewrite register definitions with DMA_BASE.
 */

#define DMA_BASE                                                 0x007f00
#define DMA_INT_STATUS                                           HW_REGISTER_RO( DMA_BASE+0xe0 ) 
...
#define DMA_ENABLE                                               HW_REGISTER_RW( DMA_BASE+0xf0 ) 
